...
const teamMembers: TeamMember[] = [
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1582750433449-648ed127bb54?q=80&w=400&auto=format&fit=crop",
    fallbackUrl: "https://via.placeholder.com/400x400/bed16b/ffffff?text=AS",
    experience: "15+ Years",
    education: "MD (Ayurveda), PhD (Holistic Medicine)",
    achievements: ["Published 50+ Research Papers", "Awarded Best Doctor 2023", "Speaker at 100+ Conferences"],
    social: {
  ...
  },
  {
    ...
    achievements: ["Ex-Google Engineer", "10+ Patents in Health Tech", "Forbes 30 Under 30"],
    social: {
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1594824883303-aef7c5324f7c?q=80&w=400&auto=format&fit=crop",
    ...
    achievements: ["Helped 5000+ Patients", "Author of 'Nutrition Revolution'", "TV Health Expert"],
    social: {
  ...
  },
  {
    ...
    achievements: ["100+ Research Publications", "NIH Grant Recipient", "International Speaker"],
    social: {
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1551836022-deb4988cc6c0?q=80&w=400&auto=format&fit=crop",
    ...
    achievements: ["UX Design Award Winner", "Ex-Apple Designer", "50+ App Launches"],
    social: {
  ...
  },
  {
    ...
    achievements: ["Traditional Medicine Expert", "5000+ Successful Treatments", "Ayurveda Research Pioneer"],
    social: {
...
const coreValues: CoreValue[] = [
  {
    ...
    description: "Every solution is tailored to your unique body, lifestyle, and goals because health is not one-size-fits-all. We believe in precision wellness.",
    color: "from-blue-500 to-cyan-500"
  },
  {
    icon: <HeartPulse className="w-12 h-12" />,
    title: "Expert-Driven Care",
    description: "Our platform is backed by certified doctors, nutritionists, and wellness experts you can trust. Quality care is our foundation.",
    color: "from-red-500 to-pink-500"
  },
  {
    icon: <Users className="w-12 h-12" />,
    title: "Community & Support",
    description: "Join a vibrant community dedicated to supporting each other on the path to better health. Together we're stronger.",
    color: "from-green-500 to-emerald-500"
  },
  {
    icon: <Lightbulb className="w-12 h-12" />,
    title: "Constant Innovation",
    description: "We are always exploring new ways to make your wellness journey more effective and enjoyable through cutting-edge technology.",
    color: "from-yellow-500 to-orange-500"
  },
  {
    icon: <ShieldCheck className="w-12 h-12" />,
    title: "Trust & Transparency",
    description: "Your health and data are sacred. We are committed to the highest standards of privacy, security, and ethical practice.",
    color: "from-purple-500 to-indigo-500"
  },
  {
    icon: <Globe className="w-12 h-12" />,
    title: "Accessible Wellness",
    description: "We believe everyone deserves access to quality healthcare. Our mission is to make wellness affordable and accessible to all.",
...
const milestones: Milestone[] = [
  {
    ...
    description: "Wellness Fuel was born with a vision to revolutionize personal healthcare through technology and expert guidance.",
    icon: <Zap className="w-8 h-8" />
  },
  {
    year: "2021",
    title: "First 1000 Users",
    description: "Reached our first milestone of 1000 active users, proving the demand for personalized wellness solutions.",
    icon: <Users className="w-8 h-8" />
  },
  {
    year: "2022",
    title: "AI Integration",
    description: "Launched our AI-powered recommendation engine, making personalized health plans more accurate and effective.",
    icon: <Brain className="w-8 h-8" />
  },
  {
    year: "2023",
    title: "50+ Expert Doctors",
    description: "Expanded our network to include 50+ certified healthcare professionals across various specialties.",
    icon: <Award className="w-8 h-8" />
  },
  {
    year: "2024",
    title: "Global Expansion",
    description: "Launched in 5 countries, bringing our wellness solutions to a global audience of health-conscious individuals.",
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-slate-600 leading-relaxed">
                ...
                cutting-edge technology, and a supportive community that empowers everyone to achieve their optimal wellness.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-slate-600 leading-relaxed">
                ...
                one-size-fits-all solutions, we saw the need for a single, trustworthy platform that simplifies 
                the path to well-being.
              </p>
              <p className="text-lg text-slate-600 leading-relaxed">
                Founded in 2020 by Dr. Anya Sharma and Rohan Verma, we started by bringing together a diverse 
                team of doctors, technologists, and wellness enthusiasts. Today, we are proud to have helped 
            ...
            >
              <div className="bg-gradient-to-r from-[#bed16b]/80 to-[#ea8f39]/80 rounded-2xl p-8 md:p-12 text-center shadow-2xl">
                ...
                <p className="text-lg text-white/90 mb-8">
                  ...
                  Get started today and discover a healthier, happier you.
                </p>
