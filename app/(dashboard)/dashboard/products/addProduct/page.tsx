...
const AddProduct = () => {
  ...
  const processImagesWithAI = async () => {
    ...
    try {
      ...
      const demoData: AIProductData = {
        ...
        longDescription: "Our premium protein powder is made from the finest whey protein isolate, providing 25g of protein per serving. Perfect for post-workout recovery and muscle building.",
        benefits: [
  ...
  const handleInputChange = (field: keyof AIProductData, value: string | string[]) => {
    setFormData(prev => ({
      ...prev,
      [field]: value
    }))
  ...
  return (
    <div className="mx-auto p-0 space-y-6">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-3xl font-bold text-foreground">AI-Powered Product Addition</h1>
          <p className="text-muted-foreground">Upload a product image and let AI extract all the details</p>
        </div>
      </div>
